...
class QuestionController {
  ...
  async add(req, res) {
    try {
      ...
      let {sub_topic_id,sub_sub_topic_id}=req.body

      console.log("-------",sub_topic_id,sub_sub_topic_id);
      var result=[]
      if (sub_topic_id == "" && sub_sub_topic_id == "") {
          result = await config.sequelize.query(
